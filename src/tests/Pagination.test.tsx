...
test('renders previous button', () => {
    ...
    const { getByText } = render(<Pagination currentPage={2} totalPages={5} handlePageChange={handlePageChange} />);
...
it('displays the active page button as selected', () => {
    const handlePageChange = jest.fn();
    const { container } = render(<Pagination currentPage={3} totalPages={5} handlePageChange={handlePageChange} />);
